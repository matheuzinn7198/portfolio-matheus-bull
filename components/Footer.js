      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            <div className="text-2xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
              Matheus Bull
            </div>
          ...
          <div className="flex justify-center space-x-6">
            ...
            <a 
              ...
              className="text-gray-400 hover:text-white transition transform hover:scale-110 p-2 rounded-lg hover:bg-white/10"
              title="LinkedIn"
            >
